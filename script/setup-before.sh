...
ACCOUNT_9_PRIV_KEY=0x2a871d0798f97d79848a013d4936a73bf4cc922c825d33c1cf7073dff6d409c6
...
cast send $WBNB --from $ACCOUNT_8 "deposit()" --value 1000000000000000000000 --private-key $ACCOUNT_8_PRIV_KEY --rpc-url $RPC_URL # 1000 BNB
cast send $WBNB --from $ACCOUNT_9 "deposit()" --value 1000000000000000000000 --private-key $ACCOUNT_9_PRIV_KEY --rpc-url $RPC_URL
