...
import "src/InterestRatesManager.sol";
...
contract TestInterestRates is InterestRatesManager, Test {
    ...
    function testIndexComputationWhenPoolSupplyIndexHasJumpedWithoutDelta()
        public
    {
        InterestRatesManager.Params memory params = InterestRatesManager.Params(
            p2pSupplyIndexTest,
    ...
    function testIndexComputationWhenPoolSupplyIndexHasJumpedWithDelta()
        public
    {
        InterestRatesManager.Params memory params = InterestRatesManager.Params(
            p2pSupplyIndexTest,
